...
- [Χ] on simulator change zoom function
- [X] integrate game functionality
	...
	- [X] INITIATE ROUND: If they decline or do not accept until the storyteller makes his choice, they will be muted from the rest group
	- [X] USER'S CHOICE: They will can navigate in the museum and investigate the paintings and when they are ready they will vote
	- [X] AT THE END OF THE ROUND: Their picks are revealed on the table as well as the storyteller’s pick
...
##22/9
- [X] change status to accepted -> voted. show for 2 mins and hide when next round starts
- [ ] try drag on vive
- [X] try teleporting everybody around scoreboard
- [X] change avatars
- [X] guest mode & fix ui menus
- [X] dress them on their answer instead of cards
- [X] deactivate headphones when audio finish
...
## bugs to fix
- [ ] colliders of hands and body should not collide
- [ ] double click become storyteller and acceptdeclineVR

- [X] double click (HIGH PR)
- [X] connection issues (HIGH PR)
- [X] check video volume in respect with distance
- [ ] outline the feelings emoji instead of the painting (LOW PR)
- [ ] να με βλέπω από έξω (LOW PR)
- [X] αφαιρεση κερσορα στη θέση που δείχνει (colliders τοιχων)
- [X] κάποιο feedback/effect στον εαυτό όταν επιλεγεις εμοτικον
...
- [X] τη ροδελα για την επιλογή εκθέματος από τον παίχτη
- [X] κάπως να σηματοδοτείται το πότε μπορεί να ξεκινήσει ένα παιχνίδι
- [X] σχετικά με το πρόβλημα με το focus και το κλείσιμο - όταν έχεις μια εικόνα zoom-in, θα μπορούσες να κλειδώνεις την κίνηση στο πίσω χώρο;
- [X] γίνεται να κοντύνω μέσα στο υπνοδωμάτιο
- [X] rank 1 1 1 4
- [X] green color to the participants of game
- [X] a bug with the storyteller
- [X] bug with the hand ?
- [X] έχω και κάποιες χωροταξικές παρατηρήσεις - π.χ τα βιντεο πρέπει να προβάλλονται στο ύψος των ματιών σου
- [X] συνέπεια στα φοντς (labels κάτω από τους πίνακες, ίδιο μέγεθος και γραμματοσειρά σε όλα)
- [X] όταν είμαι κοντά στο τραπέζι, το teleport δεν πηγαίνει εκεί που θέλω αν υπάρχει τέτοιο πρόβλημα, τότε να αλλάξουμε τη χωρική διάταξη. δλδ, έτσι όπως είναι,
που για να γίνει αφηγητής πας στη μία πλευρά, και το ταμπλώ είναι στην άλλη, το staging το αναδικνύει.
ίσως η επιγραφή να ήταν στην πλευρά στο κέντρο του τραπεζιού και λίγο πιο πίσω το scoring table
